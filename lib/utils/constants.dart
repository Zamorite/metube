...
const kTmd = EdgeInsets.only(top: 20);
const kTlg = EdgeInsets.only(top: 25);

const kBxs = EdgeInsets.only(bottom: 10);
const kBsm = EdgeInsets.only(bottom: 15);
...
const kLlg = EdgeInsets.only(left: 25);

const kRxs = EdgeInsets.only(right: 10);
...
const Color kInfo = Color(0xFFA9C4D2);
const Color kWarn = Color(0xFFCBC3C1);
